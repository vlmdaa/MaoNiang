...
export default {
  ...
  market: {
    ...
    detailVersions: '版本更新',
    detailComments: '评论',
    detailCommentsEmpty: '暂无评论',
    detailCommentsMore: '加载更多评论',
    detailCommentReplyTo: '回复 {name}',
    detailCommentHidden: '此评论已隐藏',
    detailCommentEmpty: '此评论没有文字内容',
    detailLatest: '最新',
    detailPublished: '发布于：',
    detailUpdated: '更新于：',
    detailRatings: '{count} 条评分',
    detailSource: '查看源码',
    unknownAuthor: '未知',
    filterRules: '筛选规则',
    ...
    profileWriteFailed: '包 Profile 写入失败',
    rollbackIncomplete: '回滚未完整完成，请检查插件状态后再重试。',
    overrideSourceChanged: '插件有效来源已发生变化，请刷新后重试。',
    overrideStartFailed: 'Market 版本启动失败；系统已尽可能恢复内置版本。',
    execStateRootCollision: '插件代码目录与状态目录冲突，请修改插件安装路径。',
    directoryIdentityConflict: '目标目录属于另一个插件，未进行任何更改。',
    ...
    confirmationRequired: '安装前请确认当前升级计划。'
  },
  settings: {
    channel: '更新渠道',
    channelStable: '稳定版',
  ...
  mirrorSource: {
    title: '镜像源',
    description: '选择插件市场下载 GitHub Release 包时使用的连接方式。',
    close: '关闭镜像源',
    proxyOptional: 'GitHub Proxy（可选）',
    direct: 'GitHub 直连',
    auto: '自动测速选择',
    specified: '指定代理',
    source: '镜像源',
    testing: '正在测速…',
    autoFastest: '当前最快：{source}',
    autoUnavailable: '最近测速没有可用节点，已回退 GitHub 直连。',
    autoPending: '尚未测速；将暂时使用 GitHub 直连。',
    testAndSelect: '自动测速并选择最快节点',
    recentResults: '最近测速结果',
    notice: '仅代理 github.com 的插件下载链接；包仍会按 Market 提供的 SHA-256 校验。',
    activeSource: '当前下载源：{source}',
    unavailable: '连接失败或超时',
  ...
  plugins: {
    ...
    openMirrorSource: '镜像源',
    closeMirrorSource: '收起镜像源',
  ...
  package: {
    install: {
      ...
      reinstallCancelled: '已取消重新安装。',
      reinstallSucceeded: '{plugin} 已成功重新安装。',
      downgradeTitle: '降级 {plugin}？',
      downgradeBody: '版本 {current} 将替换为较旧的版本 {target}。旧版插件可能无法兼容新版产生的数据。',
      downgradeConfirm: '降级插件',
      downgradeCancelled: '已取消降级。',
      downgradeSucceeded: '{plugin} 已成功降级。',
      ...
      error: {
        invalidArchive: '这个文件不是有效的 N.E.K.O 插件包。请重新下载，或选择 .neko-plugin / .neko-bundle 文件。',
        manifestMissing: '安装包根目录缺少包级 manifest.toml，无法安装。',
        nestedRoot: '安装包目录结构不正确，可能多压了一层父文件夹。请将 manifest.toml 和 payload/ 直接放在压缩包根目录。',
        pluginManifestMissing: '安装包中的插件缺少 plugin.toml，请让插件作者重新打包。',
  ...
  messages: {
    ...
    pluginListRefreshFailed: '插件列表刷新失败，请稍后重试',
