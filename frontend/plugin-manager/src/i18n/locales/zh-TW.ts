...
export default {
  ...
  market: {
    ...
    loginSuccess: '授權登入已完成，可以繼續使用外掛市集',
    authTokenRejected: 'Auth 授權已失效，請重新登入',
    authVerificationPending: '瀏覽器授權已返回，正在確認 Auth 身分，無需重複授權',
    authVerificationPendingLabel: '正在確認 Auth 身分',
    marketTokenRejected: 'Auth 登入有效，但 Market 未接受目前憑證',
    marketForbidden: 'Auth 登入有效，但 Market 帳號無法使用或權限不足',
    marketIdentityConflict: 'Auth 登入有效，但 Market 帳號關聯衝突；無需重複授權，請聯絡管理員',
    marketUnavailable: 'Auth 登入成功，Market 暫時無法使用，正在自動重試',
    marketInvalidResponse: 'Auth 登入成功，但 Market 傳回無法識別的回應',
    ...
    installed: '已安裝',
    usingBuiltin: '使用內建版',
    autoUpgradeBlocked: '無法自動升級',
    installing: '安裝中...',
    installSuccess: '安裝工作已建立: {name}',
    installFailed: '安裝失敗',
    installPreparing: '正在準備安裝...',
    installAlreadyRunning: '已有安裝任務正在進行，請等待其完成',
    cancelInstall: '取消安裝',
    cancelInstallUnavailable: '安裝已進入無法安全取消的階段',
    silentInstall: '靜默安裝',
    installCancelled: '安裝已取消',
    viewInstallProgress: '查看安裝進度',
    installTakingLonger: '安裝耗時超出預期，任務仍在繼續。可以繼續等待，也可以取消。',
    ...
    detailVersions: '版本更新',
    detailComments: '留言',
    detailCommentsEmpty: '暫無留言',
    detailCommentsMore: '載入更多留言',
    detailCommentReplyTo: '回覆 {name}',
    detailCommentHidden: '這則留言已隱藏',
    detailCommentEmpty: '這則留言沒有文字內容',
    detailLatest: '最新',
    detailPublished: '發布於：',
    detailUpdated: '更新於：',
    detailRatings: '{count} 則評分',
    detailSource: '查看原始碼',
    unknownAuthor: '未知',
    filterRules: '篩選規則',
    ...
    profileWriteFailed: '套件 Profile 寫入失敗',
    rollbackIncomplete: '回復未完整完成，請檢查外掛狀態後再重試。',
    overrideSourceChanged: '外掛有效來源已變更，請重新整理後再試。',
    overrideStartFailed: '市集版本啟動失敗；系統已盡可能恢復內建版本。',
    execStateRootCollision: '外掛程式碼目錄與狀態目錄衝突，請修改外掛安裝路徑。',
    directoryIdentityConflict: '目標目錄屬於另一個外掛，未進行任何變更。',
  ...
  mirrorSource: {
    title: '鏡像來源',
    description: '選擇外掛市集下載 GitHub Release 套件時使用的連線方式。',
    close: '關閉鏡像來源',
    proxyOptional: 'GitHub Proxy（選用）',
    direct: 'GitHub 直連',
    auto: '自動測速選擇',
    specified: '指定代理',
    source: '鏡像來源',
    testing: '正在測速…',
    autoFastest: '目前最快：{source}',
    autoUnavailable: '最近測速沒有可用節點，已回退 GitHub 直連。',
    autoPending: '尚未測速；將暫時使用 GitHub 直連。',
    testAndSelect: '自動測速並選擇最快節點',
    recentResults: '最近測速結果',
    notice: '僅代理 github.com 的外掛下載連結；套件仍會依 Market 提供的 SHA-256 驗證。',
    activeSource: '目前下載來源：{source}',
    unavailable: '連線失敗或逾時',
  ...
  plugins: {
    ...
    openMirrorSource: '鏡像來源',
    closeMirrorSource: '收起鏡像來源',
    ...
    importFailed: '匯入失敗',
    importDialogTitle: '匯入外掛套件',
    importDropHint: '將外掛套件拖放到這裡',
    importDropSubHint: '或點擊此處選擇檔案',
    importChooseFile: '選擇檔案',
    importFileLimit: '支援 .neko-plugin 和 .neko-bundle，最大 500 MiB',
    importUnsupportedFile: '請選擇 .neko-plugin 或 .neko-bundle 檔案',
    importFileTooLarge: '檔案超過 {limit} 的匯入上限',
    export: '匯出',
  ...
  package: {
    install: {
      ...
      reinstallCancelled: '已取消重新安裝。',
      reinstallSucceeded: '{plugin} 已成功重新安裝。',
      downgradeTitle: '降級 {plugin}？',
      downgradeBody: '版本 {current} 將替換為較舊的版本 {target}。舊版外掛可能無法相容新版產生的資料。',
      downgradeConfirm: '降級外掛',
      downgradeCancelled: '已取消降級。',
      downgradeSucceeded: '{plugin} 已成功降級。',
      ...
      error: {
        invalidArchive: '這個檔案不是有效的 N.E.K.O 外掛套件。請重新下載，或選擇 .neko-plugin / .neko-bundle 檔案。',
        manifestMissing: '安裝套件根目錄缺少套件層級的 manifest.toml，無法安裝。',
        nestedRoot: '安裝套件目錄結構不正確，可能多壓了一層父資料夾。請將 manifest.toml 與 payload/ 直接放在壓縮檔根目錄。',
        pluginManifestMissing: '安裝套件中的外掛缺少 plugin.toml，請聯絡外掛作者重新打包。',
  ...
  messages: {
    ...
    pluginListRefreshFailed: '外掛列表重新整理失敗，請稍後再試',
  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        interruptResistLight1: "喵！現在是人家的教學時間，不可以亂動滑鼠和鍵盤啦！乖乖看著人家，好不好嘛？",
        interruptResistLight2: "真是的，又在亂動滑鼠和鍵盤！再不聽話的話，人家可真的要生氣了喵！",
        interruptResistLight3: "最後警告一次喵！你要是再亂動一下，人家就直接退出新手教學，不教你了！",
        interruptAngryExit: "人家已經忍你很久了！既然你就是不肯乖乖聽話，那新手教學到此結束，接下來你自己慢慢研究吧，哼！",
